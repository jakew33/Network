<template>
  <div class="container-fluid">
    <div class="row justify-content-center align-content-center">
      <div class="card postCard elevation-1 my-3 col-md-4 justify-content-center">
        ...
        <button class="col-2 justify-content-center m-3" @click="deletePost(postProp.id)"
          v-if="postProp?.creator.id == account?.id">Delete</button>
      </div>
    </div>
  </div>
</template>
